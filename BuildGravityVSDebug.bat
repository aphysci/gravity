...
set CONFIGURATION= /p:Configuration=Debug 
set BIN_DIR=debug_bin
set LIB_DIR=debug_lib
set BUILD_DIR=Debug
set ZIP_OUT_NAME=gravity-MSVC11-Debug.zip
...
copy ..\..\lib\Win32\libzmq_d.lib ..\..\..\%LIB_DIR%\libzmq_d.lib
copy ..\..\bin\Win32\libzmq_d.dll ..\..\..\%BIN_DIR%\libzmq_d.dll
