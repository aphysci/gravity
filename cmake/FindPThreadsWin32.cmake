...
if (WIN32)
    ...
    if (NOT PThreadsWin32_INSTALL_DIR)
        ...
        find_library(PThreadsWin32Lib_Installed NAMES pthreadVC2 PATHS "${PThreadsWin32_INSTALL_DIR}/lib")
        find_file(PThreadsWin32Dll_Installed NAMES pthreadVC2.dll PATHS "${PThreadsWin32_INSTALL_DIR}/bin")
        ...
        find_file(PThreadsWin32_Include_File NAMES pthread.h PATHS "${PThreadsWin32_INSTALL_DIR}/include")
