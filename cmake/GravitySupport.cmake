...
macro(gravity_find_zeromq found_external fail_if_missing)
    set(${found_external} OFF)
    if (NOT GRAVITY_USE_INTERNAL_ZEROMQ)
        find_package(ZeroMQ)
    endif()
    if (ZeroMQ_FOUND)
        set(${found_external} ON)
    else()
        find_package(ZeroMQ PATHS "${CMAKE_INSTALL_PREFIX}/deps/libzmq/CMake" "${CMAKE_INSTALL_PREFIX}/deps/libzmq/share/cmake")
    endif()
    if (fail_if_missing AND NOT ZeroMQ_FOUND)
