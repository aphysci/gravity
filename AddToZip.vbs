'Modified from http://www.naterice.com/blog/template_permalink.asp?id=64
WindowsZip WScript.Arguments.Item(0), WScript.Arguments.Item(1) 
...
Function WindowsZip(sFile, sZipFile)
  ...
  sZipFile = fso.GetAbsolutePathName(sZipFile)
  sFile = fso.GetAbsolutePathName(sFile)
