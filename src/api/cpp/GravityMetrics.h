 ...
 */
class GRAVITY_API GravityMetrics
{
private:
...
public:
     ...
     */
    GravityMetrics(void* socket);

    /**
     * Default Destructor
     */
    virtual ~GravityMetrics();
     ...
     */
    void incrementMessageCount(std::string dataProductID, int count);
     ...
     */
    void incrementByteCount(std::string dataProductID, int count);
     ...
     */
    void remove(std::string dataProductID);
     ...
     */
    int getMessageCount(std::string dataProductID);
     ...
     * \return byte count
     */
    int getByteCount(std::string dataProductID);
     ...
     */
    void populateFromMessage(void* socket);
     ...
     */
    std::vector<std::string> getDataProductIDs();
};
